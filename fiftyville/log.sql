...
--Witness 2 Eugene regarding ATM--
SELECT *FROM atm_transactions
WHERE atm_location = 'Leggett Street'
AND year = 2023 AND month = 7 AND day = 28;
--Names of withdraw ATM--
SELECT a.*, p.name
...
--Narrowing it between Bruce and Diana by seeing who was on the flight--
SELECT p.name
FROM people p
