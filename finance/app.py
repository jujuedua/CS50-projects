...
def index():
    ...
    # Initialize variables for total valus
    total_value = cash
    grand_total = cash
...
def buy():
    ...
    if request.method == "POST":
        ...
        if not symbol:
            ...
            return apology("must provide a positive interger number of shares")
...
def history():
    ...
    # Query database for user's transactions, orederd by most recent first
